...
namespace FDK.メディア.サウンド.WASAPI
{
	...
	///		リサンプラーあり版。
	/// </summary>
	public class NVorbisResampledWaveSource : IWaveSource
	{
		...
		/// </summary>
		public NVorbisResampledWaveSource( Stream stream, WaveFormat deviceFormat )
		{
			...
			using( var vorbisSource = new NVorbisSampleSource( stream, deviceFormat ) )
